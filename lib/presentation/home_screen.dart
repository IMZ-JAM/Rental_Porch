...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  Container(
        decoration: const BoxDecoration(image: DecorationImage(image: NetworkImage("https://img.freepik.com/vector-premium/mapa-ciudad-cualquier-tipo-informacion-grafica-digital-publicacion-impresa-mapa-gps_403715-37.jpg?w=2000"), fit: BoxFit.cover)),
      ),
      floatingActionButton: const Bottoms_zoom(),
...
class Bottoms_zoom extends StatelessWidget {
  const Bottoms_zoom({
    super.key,
  });
